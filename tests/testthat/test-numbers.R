...
test_that("pretty_num converts properly", {
  expect_equal(pretty_num(1e-32), '0.01 q')
...
test_that("compute_num handles `smallest_prefix` properly", {
  expect_equal(
    compute_num(1e-24, smallest_prefix = "m"),
    data.frame(
      amount = 1e-21,
      prefix = "m",
      negative = FALSE,
  ...
  expect_equal(
    compute_num(-1e-4, smallest_prefix = "m"),
    data.frame(
      amount = 0.1,
      prefix = "m",
      negative = TRUE,
  ...
  expect_equal(
    compute_num(-0.01, smallest_prefix = "m"),
    data.frame(
      amount = 10,
      prefix = "m",
      negative = TRUE,
  ...
  expect_equal(
    compute_num(0, smallest_prefix = "m"),
    data.frame(
      amount = 0,
      prefix = "",
      negative = FALSE,
